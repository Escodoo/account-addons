...
def post_init_hook(cr, registry):
    ...
    _logger.info(_("Loading l10n_br_cnab_structure_payment_bb data files."))

    for file in files:
        tools.convert_file(
            cr,
            "l10n_br_cnab_structure_payment_bb",
            file,
            None,
            mode="init",
            noupdate=True,
    ...
    cr.execute(
        "select demo from ir_module_module where name='l10n_br_cnab_structure_payment_bb';"
    )
    if cr.fetchone()[0]:
        demofiles = [
        ...
        _logger.info(_("Loading l10n_br_cnab_structure_payment_bb demo files."))
