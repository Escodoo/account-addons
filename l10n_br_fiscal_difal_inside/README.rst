...
.. |badge3| image:: https://img.shields.io/badge/github-Escodoo%2Faccount--addons-lightgray.png?logo=github
    :target: https://github.com/Escodoo/account-addons/tree/16.0/l10n_br_fiscal_difal_inside
...
`feedback <https://github.com/Escodoo/account-addons/issues/new?body=module:%20l10n_br_fiscal_difal_inside%0Aversion:%2016.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `Escodoo/account-addons <https://github.com/Escodoo/account-addons/tree/16.0/l10n_br_fiscal_difal_inside>`_ project on GitHub.
